...
from .action_contracts import action_contract_summary, action_contract_tool_items_schema
...
RULES: dict[str, str] = {
    ...
    "scoring": "Objective completion and escape are primary. Secondary reward credits survival, exploration, room discovery, treasure, defeated monsters, and unique achievements. Invalid actions and damage are penalized.",
}
