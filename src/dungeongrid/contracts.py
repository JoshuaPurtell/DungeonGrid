...
RULES: dict[str, str] = {
    ...
    "messages": "message costs 1 AP. Use target party or a visible hero id from the party roster, with payload.text, to share durable coordination notes rendered in later observations. In solo runs, messages are treated as notes, not collaboration.",
